// views/camp-manager/DistributionList.tsx
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="bg-white rounded-[2rem] border shadow-sm p-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 text-sm font-bold mt-1 mr-12">عرض ومتابعة حملات توزيع المساعدات</p>
          </div>
          <Link
      ...
      <div className="space-y-6">
        {paginatedCampaigns.length === 0 ? (
          <div className="bg-white rounded-[2rem] border shadow-sm p-12 text-center">
            ...
            <p className="text-gray-400 text-sm font-bold mt-1">جرب تغيير معايير التصفية أو أضف حملة جديدة</p>
          </div>
        ) : (
              ...
              <div key={campaign.id} className="bg-white rounded-[2rem] border shadow-sm overflow-hidden hover:shadow-md transition-all">
                <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 border-b border-amber-100">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <Link
                        to={`/manager/distribution/${campaign.id}`}
                        className="px-6 py-3 bg-gradient-to-r from-amber-600 to-orange-600 text-white rounded-xl font-bold text-sm hover:from-amber-700 hover:to-orange-700 transition-all shadow-md flex items-center gap-2"
                      >
      ...
      <div className="bg-white rounded-[2rem] border shadow-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link
            to="/manager/aid-campaigns"
            className="p-4 bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl border-2 border-amber-200 hover:border-amber-400 transition-all flex items-center gap-3"
          >
            ...
            <div>
              <p className="font-black text-gray-800 text-sm">إنشاء حملة</p>
              <p className="text-xs text-gray-500 font-bold">حملة مساعدة جديدة</p>
            </div>
          </Link>
          <Link
            to="/manager/distribution-history"
          ...
          >
            ...
            <div>
              <p className="font-black text-gray-800 text-sm">سجل المخزون</p>
              <p className="text-xs text-gray-500 font-bold">متابعة المخزون</p>
            </div>
          </Link>
        </div>
      </div>
