...
const DPDetails: React.FC = () => {
  ...
  const loadDP = async () => {
    try {
      ...
      // Fallback: if getDPById returns null, try fetching from getDPs list
      if (!foundDP) {
        console.log('[DPDetails] getDPById returned null, trying fallback method...');
        if (currentCampId) {
          const allDps = await realDataService.getDPs(currentCampId);
  ...
  const canEdit = () => {
    const currentUser = sessionService.getCurrentUser();
    return currentUser?.role === 'SYSTEM_ADMIN' || currentUser?.role === 'CAMP_MANAGER';
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updateData: any = {
        ...
        head_first_name: cleanedData.headFirstName,
        head_father_name: cleanedData.headFatherName,
        head_grandfather_name: cleanedData.headGrandfatherName,
        head_family_name: cleanedData.headFamilyName,
        head_of_family_national_id: cleanedData.nationalId,
        ...
        head_of_family_marital_status: cleanedData.maritalStatus,
        head_of_family_widow_reason: cleanedData.widowReason,
        head_of_family_role: cleanedData.headRole,
        head_of_family_phone_number: cleanedData.phoneNumber,
        head_of_family_phone_secondary: cleanedData.phoneSecondary,
        head_of_family_disability_type: cleanedData.disabilityType,
        head_of_family_disability_severity: cleanedData.disabilitySeverity,
        head_of_family_disability_details: cleanedData.disabilityDetails,
        head_of_family_chronic_disease_type: cleanedData.chronicDiseaseType,
        head_of_family_chronic_disease_details: cleanedData.chronicDiseaseDetails,
        head_of_family_war_injury_type: cleanedData.warInjuryType,
        head_of_family_war_injury_details: cleanedData.warInjuryDetails,
        head_of_family_medical_followup_required: cleanedData.medicalFollowupRequired,
        head_of_family_medical_followup_frequency: cleanedData.medicalFollowupFrequency,
        head_of_family_medical_followup_details: cleanedData.medicalFollowupDetails,
        head_of_family_is_working: cleanedData.isWorking,
        head_of_family_job: cleanedData.job,
        head_of_family_monthly_income: cleanedData.monthlyIncome,
        head_of_family_monthly_income_range: cleanedData.monthlyIncomeRange || null,

        // Wife information
        wife_name: cleanedData.wifeName,
        wife_national_id: cleanedData.wifeNationalId,
        ...
        wife_pregnancy_followup_details: cleanedData.wifePregnancyFollowupDetails,
        wife_is_working: cleanedData.wifeIsWorking,
        wife_occupation: cleanedData.wifeOccupation,
        wife_medical_followup_required: cleanedData.wifeMedicalFollowupRequired,
        wife_medical_followup_frequency: cleanedData.wifeMedicalFollowupFrequency,
        wife_medical_followup_details: cleanedData.wifeMedicalFollowupDetails,
        wife_disability_type: cleanedData.wifeDisabilityType,
        wife_disability_severity: cleanedData.wifeDisabilitySeverity,
        wife_disability_details: cleanedData.wifeDisabilityDetails,
        wife_chronic_disease_type: cleanedData.wifeChronicDiseaseType,
        wife_chronic_disease_details: cleanedData.wifeChronicDiseaseDetails,
        wife_war_injury_type: cleanedData.wifeWarInjuryType,
        wife_war_injury_details: cleanedData.wifeWarInjuryDetails,

        // Husband information (for female-headed households)
        husband_name: cleanedData.husbandName,
        husband_national_id: cleanedData.husbandNationalId,
        husband_date_of_birth: cleanedData.husbandDateOfBirth,
        husband_is_working: cleanedData.husbandIsWorking,
        husband_occupation: cleanedData.husbandOccupation,
        husband_medical_followup_required: cleanedData.husbandMedicalFollowupRequired,
        husband_medical_followup_frequency: cleanedData.husbandMedicalFollowupFrequency,
        husband_medical_followup_details: cleanedData.husbandMedicalFollowupDetails,
        husband_disability_type: cleanedData.husbandDisabilityType,
        husband_disability_severity: cleanedData.husbandDisabilitySeverity,
        husband_disability_details: cleanedData.husbandDisabilityDetails,
        husband_chronic_disease_type: cleanedData.husbandChronicDiseaseType,
        husband_chronic_disease_details: cleanedData.husbandChronicDiseaseDetails,
        husband_war_injury_type: cleanedData.husbandWarInjuryType,
        husband_war_injury_details: cleanedData.husbandWarInjuryDetails,

        // Family counts - AUTO-CALCULATED BY TRIGGERS - EXCLUDED
        // total_members_count, male_count, female_count, child_count, etc.
        
        // Original housing
        original_address_governorate: editableData.originalAddressGovernorate,
        original_address_region: editableData.originalAddressRegion,
        original_address_details: editableData.originalAddressDetails,
        original_address_housing_type: editableData.originalAddressHousingType,
        
        // Current housing
        current_housing_type: editableData.currentHousingType,
        current_housing_sharing_status: editableData.currentHousingSharingStatus,
        current_housing_detailed_type: editableData.currentHousingDetailedType,
        current_housing_furnished: editableData.currentHousingFurnished,
        current_housing_unit_number: editableData.unitNumber,
        current_housing_is_suitable_for_family_size: editableData.currentHousingIsSuitable,
        current_housing_sanitary_facilities: editableData.currentHousingSanitaryFacilities,
        current_housing_water_source: editableData.currentHousingWaterSource,
        current_housing_electricity_access: editableData.currentHousingElectricityAccess,
        current_housing_governorate: editableData.currentHousingGovernorate,
        current_housing_region: editableData.currentHousingRegion,
        current_housing_landmark: editableData.currentHousingLandmark,

        // Refugee/resident abroad
        is_resident_abroad: editableData.isResidentAbroad ?? false,
        refugee_resident_abroad_country: editableData.refugeeResidentAbroadCountry,
        refugee_resident_abroad_city: editableData.refugeeResidentAbroadCity,
        refugee_resident_abroad_residence_type: editableData.refugeeResidentAbroadResidenceType,
        
        // Vulnerability - AUTO-CALCULATED BY TRIGGERS - EXCLUDED
        // vulnerability_score, vulnerability_priority
        vulnerability_reason: editableData.vulnerabilityReason,
        
        // Admin fields
        admin_notes: editableData.adminNotes,
        nomination_body: editableData.nominationBody,
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
          ...
          <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-lg sm:text-2xl font-black text-gray-800 flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-blue-600 to-indigo-600 text-white rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-center sm:justify-end flex-shrink-0">
            ...
            {!isEditMode && canEdit() && (
              <button
                ...
                title="تحديد الحقول القابلة للتعديل"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-2">
        <div className="flex flex-wrap gap-1 sm:gap-2 justify-center">
          ...
          {(() => {
            ...
            const currentGender = isEditMode && editableData ? editableData.gender : dp.gender;
            const currentMaritalStatus = isEditMode && editableData ? editableData.maritalStatus : dp.maritalStatus;
            
            // Show spouse tab if married (not single) OR if spouse name exists
            const showSpouseTab = currentMaritalStatus !== 'أعزب' || 
          ...
          <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6">
            ...
            {isEditMode && editableData ? (
              <div className="space-y-3">
                ...
                {editableData.disabilityType && editableData.disabilityType.trim() !== 'لا يوجد' && (
                  <>
                    <div>
                ...
                {editableData.chronicDiseaseType && editableData.chronicDiseaseType.trim() !== 'لا يوجد' && (
                  <div>
                ...
                {editableData.warInjuryType && editableData.warInjuryType.trim() !== 'لا يوجد' && (
                  <div>
      ...
      {activeTab === 'spouse' && (
        <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6">
          ...
          {isEditMode && editableData ? (
            <div className="space-y-6">
              {/* Conditional Spouse Information based on head gender */}
              {isMaleHead(editableData.headRole, editableData.gender) ? (
                ...
                <div className="bg-pink-50 border-2 border-pink-100 rounded-xl p-4">
                  ...
                  {/* Pregnancy Information (for wife only) */}
                  ...
                  {/* Work Information */}
                  <div className="border-t pt-4">
                    <h4 className="font-black text-pink-700 mb-3">معلومات العمل</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {editableData.wifeName && (
                        <>
                          <div className="flex items-center gap-2">
                  ...
                  {/* Health Information */}
                  <div className="border-t pt-4">
                    <h4 className="font-black text-pink-700 mb-3">الحالة الصحية</h4>
                    <div className="space-y-4">
                      {editableData.wifeName && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                          ...
                          {editableData.wifeDisabilityType && editableData.wifeDisabilityType.trim() !== 'لا يوجد' && (
                            <>
                              <div>
                          ...
                          {editableData.wifeChronicDiseaseType && editableData.wifeChronicDiseaseType.trim() !== 'لا يوجد' && (
                            <div className="md:col-span-2">
                              <label className="block text-sm font-bold text-gray-700 mb-2">تفاصيل المرض المزمن</label>
                              <textarea
                          ...
                          {editableData.wifeWarInjuryType && editableData.wifeWarInjuryType.trim() !== 'لا يوجد' && (
                            <div className="md:col-span-2">
                ...
                <div className="bg-blue-50 border-2 border-blue-100 rounded-xl p-4">
                  ...
                  {/* Work Information */}
                  <div className="border-t pt-4">
                    <h4 className="font-black text-blue-700 mb-3">معلومات العمل</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {editableData.husbandName && (
                        <>
                          <div className="flex items-center gap-2">
                            <input
                              type="checkbox"
                  ...
                  {/* Health Information */}
                  <div className="border-t pt-4">
                    <h4 className="font-black text-blue-700 mb-3">الحالة الصحية</h4>
                    <div className="space-y-4">
                      {editableData.husbandName && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                          ...
                          {editableData.husbandDisabilityType && editableData.husbandDisabilityType.trim() !== 'لا يوجد' && (
                            <>
                              <div>
                                <label className="block text-sm font-bold text-gray-700 mb-2">شدة الإعاقة</label>
                                <select
                          ...
                          {editableData.husbandChronicDiseaseType && editableData.husbandChronicDiseaseType.trim() !== 'لا يوجد' && (
                            <div className="md:col-span-2">
                              <label className="block text-sm font-bold text-gray-700 mb-2">تفاصيل المرض المزمن</label>
                              <textarea
                          ...
                          {editableData.husbandWarInjuryType && editableData.husbandWarInjuryType.trim() !== 'لا يوجد' && (
                            <div className="md:col-span-2">
                              <label className="block text-sm font-bold text-gray-700 mb-2">تفاصيل الإصابة الحربية</label>
                              <textarea
            ...
            <div className="space-y-3">
              {/* Conditional Spouse Information based on head gender - View Mode */}
              {isMaleHead(dp.headRole, dp.gender) ? (
                /* Wife Information (Male-headed household) - View Mode */
                <>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  {/* Health Information */}
                  {((dp.wifeDisabilityType && dp.wifeDisabilityType.trim() !== 'لا يوجد') ||
                   (dp.wifeChronicDiseaseType && dp.wifeChronicDiseaseType.trim() !== 'لا يوجد') ||
                   (dp.wifeWarInjuryType && dp.wifeWarInjuryType.trim() !== 'لا يوجد') ||
                ...
                /* Husband Information (Female-headed household) - View Mode */
                <>
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  ...
                  {/* Health Information */}
                  {((dp.husbandDisabilityType && dp.husbandDisabilityType.trim() !== 'لا يوجد') ||
                   (dp.husbandChronicDiseaseType && dp.husbandChronicDiseaseType.trim() !== 'لا يوجد') ||
                   (dp.husbandWarInjuryType && dp.husbandWarInjuryType.trim() !== 'لا يوجد') ||
