-- Migration 018: Convert All Enum Values from English to Arabic
-- This script converts all existing English enum values to Arabic in the database
-- Run AFTER updating the schema CHECK constraints

-- =====================================================
-- FAMILES TABLE - Enum Value Conversions
-- =====================================================
...
-- Medical Follow-up Frequency (Head of Family)
UPDATE families SET 
  head_of_family_medical_followup_frequency = CASE
    WHEN head_of_family_medical_followup_frequency = 'daily' THEN 'يومي'
    WHEN head_of_family_medical_followup_frequency = 'weekly' THEN 'أسبوعي'
    WHEN head_of_family_medical_followup_frequency = 'monthly' THEN 'شهري'
    ELSE head_of_family_medical_followup_frequency
  END
WHERE head_of_family_medical_followup_frequency IN ('daily', 'weekly', 'monthly');
...
-- Current Housing Detailed Type
UPDATE families SET 
  current_housing_detailed_type = CASE
    WHEN current_housing_detailed_type = 'tent_individual' THEN 'خيمة فردية'
    WHEN current_housing_detailed_type = 'tent_shared' THEN 'خيمة مشتركة'
    WHEN current_housing_detailed_type = 'house_full' THEN 'منزل كامل'
    WHEN current_housing_detailed_type = 'house_room' THEN 'غرفة في منزل'
    WHEN current_housing_detailed_type = 'apartment_furnished' THEN 'شقة مفروشة'
    WHEN current_housing_detailed_type = 'apartment_unfurnished' THEN 'شقة غير مفروشة'
    WHEN current_housing_detailed_type = 'caravan' THEN 'كارافان'
    WHEN current_housing_detailed_type = 'other' THEN 'آخر'
    ELSE current_housing_detailed_type
  END
WHERE current_housing_detailed_type IN ('tent_individual', 'tent_shared', 'house_full', 'house_room', 'apartment_furnished', 'apartment_unfurnished', 'caravan', 'other');
...
-- Wife Medical Follow-up Frequency
UPDATE families SET 
  wife_medical_followup_frequency = CASE
    WHEN wife_medical_followup_frequency = 'daily' THEN 'يومي'
    WHEN wife_medical_followup_frequency = 'weekly' THEN 'أسبوعي'
    WHEN wife_medical_followup_frequency = 'monthly' THEN 'شهري'
    ELSE wife_medical_followup_frequency
  END
WHERE wife_medical_followup_frequency IN ('daily', 'weekly', 'monthly');
...
-- Medical Follow-up Frequency
UPDATE individuals SET 
  medical_followup_frequency = CASE
    WHEN medical_followup_frequency = 'daily' THEN 'يومي'
    WHEN medical_followup_frequency = 'weekly' THEN 'أسبوعي'
    WHEN medical_followup_frequency = 'monthly' THEN 'شهري'
    ELSE medical_followup_frequency
  END
WHERE medical_followup_frequency IN ('daily', 'weekly', 'monthly');

-- =====================================================
-- CAMPS TABLE - Status Conversion
-- =====================================================
...
-- =====================================================
-- DISTRIBUTIONS TABLE - Status Conversion
-- =====================================================
...
-- =====================================================
-- DISTRIBUTION_RECORDS TABLE - Status Conversion
-- =====================================================
...
-- =====================================================
-- INVENTORY TABLE - Category Conversion
-- =====================================================
...
-- =====================================================
-- AID_CAMPAIGNS TABLE - Status and Category Conversion
-- =====================================================
...
UPDATE aid_campaigns SET 
  aid_category = CASE
    WHEN aid_category = 'food' THEN 'غذاء'
    WHEN aid_category = 'non_food' THEN 'غير غذائي'
    WHEN aid_category = 'medical' THEN 'طبي'
    WHEN aid_category = 'cash' THEN 'نقدي'
    WHEN aid_category = 'other' THEN 'أخرى'
    ELSE aid_category
  END
WHERE aid_category IN ('food', 'non_food', 'medical', 'cash', 'other');

-- =====================================================
-- BACKUP_SYNC_OPERATIONS TABLE - Conversion
-- =====================================================
...
-- =====================================================
-- IMPORT_EXPORT_OPERATIONS TABLE - Conversion
-- =====================================================
...
-- =====================================================
-- Note: After running this script, verify all data is correct
-- and update application code to use Arabic values
-- =====================================================
