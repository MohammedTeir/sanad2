-- =====================================================
-- ENUM TO ARABIC MIGRATION - WITH CONSTRAINT DROP
-- This script drops constraints, updates data, then you can recreate constraints
-- =====================================================

-- =====================================================
-- STEP 1: DROP ALL CHECK CONSTRAINTS
-- =====================================================
...
-- =====================================================
-- STEP 3: UPDATE INDIVIDUALS DATA
-- =====================================================
...
SELECT 'FAMILIES WITH ENGLISH VALUES: ' || COUNT(*) as result
FROM families 
...
SELECT 'INDIVIDUALS WITH ENGLISH VALUES: ' || COUNT(*) as result
FROM individuals 
