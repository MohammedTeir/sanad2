      ...
      try {
        ...
        for (const familyRecord of familyRecords) {
          ...
          const dp: DPProfile = {
            ...
            childCount: familyRecord.child_count || 0,
            teenagerCount: familyRecord.teenager_count || 0,
            adultCount: familyRecord.adult_count || 0,
            seniorCount: familyRecord.senior_count || 0,
            disabledCount: familyRecord.disabled_count || 0,
            injuredCount: familyRecord.injured_count || 0,
            chronicCount: familyRecord.chronic_count || 0,
            pregnantWomenCount: familyRecord.pregnant_women_count || 0,
            orphanCount: familyRecord.orphan_count || 0,
            originalAddress: {
            ...
            originalAddressGovernorate: familyRecord.original_address_governorate || familyRecord.original_address?.governorate || familyRecord.originalAddress?.governorate,
            originalAddressRegion: familyRecord.original_address_region || familyRecord.original_address?.region || familyRecord.originalAddress?.region,
            originalAddressDetails: familyRecord.original_address_details || familyRecord.original_address?.details || familyRecord.originalAddress?.details,
            originalAddressHousingType: familyRecord.original_address_housing_type || familyRecord.original_address?.housing_type || familyRecord.originalAddress?.housingType,
            currentHousingType: familyRecord.current_housing_type || familyRecord.current_housing?.type || familyRecord.currentHousing?.type,
            currentHousingIsSuitable: familyRecord.current_housing_is_suitable_for_family_size !== undefined ? familyRecord.current_housing_is_suitable_for_family_size : (familyRecord.current_housing?.is_suitable_for_family_size !== undefined ? familyRecord.current_housing?.is_suitable_for_family_size : familyRecord.currentHousing?.isSuitableForFamilySize),
            currentHousingSanitaryFacilities: familyRecord.current_housing_sanitary_facilities || familyRecord.current_housing_sanitary_conditions || familyRecord.current_housing?.sanitary_facilities || familyRecord.currentHousing?.sanitaryFacilities,
            currentHousingWaterSource: familyRecord.current_housing_water_source || familyRecord.current_housing?.water_source || familyRecord.currentHousing?.waterSource,
            currentHousingElectricityAccess: familyRecord.current_housing_electricity_access || familyRecord.current_housing?.electricity_access || familyRecord.currentHousing?.electricityAccess,
            currentHousingGovernorate: familyRecord.current_housing_governorate || familyRecord.current_housing?.governorate || familyRecord.currentHousing?.governorate,
            currentHousingRegion: familyRecord.current_housing_region || familyRecord.current_housing?.region || familyRecord.currentHousing?.region,
            currentHousingLandmark: familyRecord.current_housing_landmark || familyRecord.current_housing?.landmark || familyRecord.currentHousing?.landmark,
